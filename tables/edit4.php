...
<body>
  ...
  <div class="center">
    ...
    if (mysqli_connect_errno() != 0) {
      ...
      $result = mysqli_query($connect, "SELECT IDT as 'ID', IDA as 'ID Autobusu', IDPK as 'ID Przystanku Końcowego' FROM rozkladjazdy WHERE IDT = $id");
      if ($result === FALSE) {
        ...
        while (($row = mysqli_fetch_array($result)) !== NULL) {
          $keys = array_keys($row);
          echo '<form action="save4.php" method="post" class="przeslij">';
          ...
          echo '<a href="../tables/tabela4.php"><input type="button" value="anuluj" name="anuluj"></a>';
          echo '</form>';
