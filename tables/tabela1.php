    ...
    <div class="tableContent">
      ...
      <div class="table">
        ...
        if (mysqli_connect_errno() != 0) {
          ...
          $result = mysqli_query($connect, "SELECT k.IDK as ID, k.Imie as 'Imię', k.Nazwisko, k.IDA as 'ID autobusu', a.Rejestracja, k.Wynagrodzenie FROM kierowcy k LEFT OUTER JOIN autobusy a
          ON k.IDA = a.IDA
          ORDER BY k.IDK ASC");
      ...
      <a href="create1.php"><input type="button" value="nowy rekord"></a>
    </div>
  </div>
