...
<body>
  ...
  <div class="center">
    ...
    if (mysqli_connect_errno() != 0) {
      ...
      $result = mysqli_query($connect, "SELECT IDA as 'ID', Rejestracja FROM autobusy WHERE IDA = $id");
      if ($result === FALSE) {
        ...
        while (($row = mysqli_fetch_array($result)) !== NULL) {
          $keys = array_keys($row);
          echo '<form action="save2.php" method="post" class="przeslij">';
          ...
          echo '<a href="../tables/tabela2.php"><input type="button" value="anuluj" name="anuluj"></a>';
          echo '</form>';
