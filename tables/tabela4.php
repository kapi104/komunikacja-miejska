    ...
    <div class="tableContent">
      ...
      <div class="table">
        ...
        if (mysqli_connect_errno() != 0) {
          ...
          $result = mysqli_query($connect, "SELECT r.IDT as 'ID', a.Rejestracja as 'autobus', p.Ulica as 'przystanek', p.przyjazd, p.odjazd 
          FROM rozkladjazdy r 
          LEFT OUTER JOIN autobusy a 
          ON r.IDA = a.IDA
          LEFT OUTER JOIN przystanki p
          ON r.IDPK = p.IDP");
      ...
      <a href="create4.php"><input type="button" value="nowy rekord"></a>
    </div>
  </div>
