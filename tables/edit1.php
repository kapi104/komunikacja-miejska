    ...
    <?php
      ...
      $db_host = 'localhost';
          ...
          if (mysqli_connect_errno() != 0) {
            ...
            $result = mysqli_query($connect, "SELECT k.IDK as ID, k.Imie as 'Imię', k.Nazwisko, k.IDA, k.Wynagrodzenie FROM kierowcy k NATURAL JOIN autobusy a WHERE IDK = $id");
            if ($result === FALSE) {
              ...
              while (($row = mysqli_fetch_array($result)) !== NULL) {
                $keys = array_keys($row);
                echo '<form action="save1.php" method="post" class="przeslij">';
                  ...
                  echo '<a href="../tables/tabela1.php"><input type="button" value="anuluj" name="anuluj"></a>';
                echo '</form>';
